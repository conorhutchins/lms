    ...
    <section className="py-16 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step) => (
            <Card key={step.number} className="text-center card-hover border-primary/20 bg-card/80">
              <CardHeader className="pb-2">
                <div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-2xl font-bold mx-auto shadow-lg shadow-primary/20">
                  {step.number}
                </div>
        ...
        <div className="mt-12 text-center">
          <Card className="max-w-md mx-auto card-hover border-secondary/30 bg-card/80">
            <CardHeader className="bg-secondary/10 rounded-t-lg">
              <CardTitle className="text-secondary">Private Competitions</CardTitle>
