    ...
    <footer className="bg-background py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Last Man Standing HQ</h3>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Have questions? Email us at <a href="mailto:support@lastmanstandinghq.com" className="underline">support@lastmanstandinghq.com</a>
            </p>
          </div>
        </div>
