...
// Removed the FacebookIcon import since we're using SVG directly

// Use relative paths from pages directory to src directory
import { createClient } from '../src/lib/supabase/client'
import { Button } from "../src/components/ui/button"
import { Input } from "../src/components/ui/input"
// Removed CardDescription as it's not used in the target signup layout
import { Card, CardContent, CardHeader, CardTitle } from "../src/components/ui/card"
import Image from 'next/image' // Assuming logo will be added
...
export default function LoginPage() {
  ...
  const handleEmailSignIn = async (event: FormEvent) => {
    ...
    if (error) {
      ...
      // Redirect to dashboard or intended page upon successful login
  ...
  return (
    <div className="absolute inset-0 bg-black overflow-auto">
      <div className="flex justify-center items-center min-h-screen w-full text-white p-4 box-border">
        <Card className="w-full max-w-md mx-auto bg-[#111111] border-0 shadow-lg my-12">
          <CardHeader className="text-center pt-10 pb-6">
            ...
            <CardTitle className="text-2xl font-normal text-white">Log in to Last Man Standing HQ</CardTitle>
          </CardHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="text-center mt-8">
                <p className="text-[#888]">
                  ...
                  <Link href="/signup" className="text-white hover:text-purple-400 ml-1">
                    Sign up →
                  </Link>
                </p>
              </div>
